...
android {
    compileSdk = 34
    namespace = "dreiz0x.vespa"
    defaultConfig { applicationId = "com.spen.app"; minSdk = 24; targetSdk = 34; versionCode = 1; versionName = "1.0"; testInstrumentationRunner = "androidx.test.runner.AndroidJUnitRunner" }
